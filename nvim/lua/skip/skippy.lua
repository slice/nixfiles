...
local spec = lush(function(injected_functions)
  ...
  local function bg_2()
    return Normal.bg.li(15)
  end
  local function bg_3()
    return Normal.bg.li(20)
  end
  local function bg_fg()
    return Normal.bg.li(35).de(30)
  end
  local function frozen()
    return Normal.bg.li(10).de(30)
  end
  local function chalk()
    return Normal.fg.li(40)
  end
  ...
  return {
    ...
    StatusLineTerm {
      fg = 'black',
      bg = StatusLine.bg.hue(140).li(10),
      bold = true,
    },
    ...
    Comment {
      bg = Normal.bg.li(10),
      fg = Normal.fg.hue(Normal.bg.h).da(30).sa(20),
      italic = true,
    },
    ...
    -- class decls
    sym '@lsp.typemod.class.declaration' {
      fg = neon.hue(20),
      bg = neon.hue(20).da(80),
      bold = true,
    },
